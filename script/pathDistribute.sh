...
do
    ...
    then
        echo ""
        echo "-----"$i"-----"
        ./filter.awk $bgpfile | ./pathDistribute.awk > $bgpout
        ./filter.awk $pdarfile | ./pathDistribute.awk > $pdarout
        ./filter.awk $mdrfile | ./pathDistribute.awk > $mdrout
